...
const ScreenshotFrame: React.FC<{
  ...
  return (
    <figure className="flex flex-col items-center">
      <div
        className={`relative overflow-hidden border border-gray-200 bg-gray-900 shadow-floating ${
          isPhone ? 'w-[220px] rounded-[2rem] p-2' : 'w-full max-w-md rounded-[1.25rem] p-2.5'
        }`}
      >
        <div className={`overflow-hidden bg-white ${isPhone ? 'rounded-[1.5rem]' : 'rounded-xl'}`}>
          {!failed ? (
            <img
              src={imageSrc}
              alt={alt}
            ...
            <div
              className={`flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 text-center ${
