...
const BookDashboard: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="rounded-3xl border border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50 p-6 md:p-8 shadow-lg">
        ...
        <p className="text-gray-700 mb-6 text-center text-sm md:text-base">
          Practice vocabulary with interactive exercises tailored to your
          learning style
        </p>
